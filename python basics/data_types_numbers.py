...
print ("The result of 3 / 4 is ", (3 / 4), " and Data Type is ", type(3 / 4))
print ("The result of 3 // 4 is ", (3 // 4), " and Data Type is ", type(3 // 4))
print ("The result of 33 // 4 is ", (33 // 4), " which is quotient and Data Type is ", type(33 // 4))
print ("The result of 33 % 4 is ", (33 % 4), " which is remainder and Data Type is ", type(33 % 4))
print ("The result of 3 + (11 / 4) is ", (3 + (11 / 4)), " and Data Type is ", type(3 + (11 / 4)))
print ("The result of 3 ** 4 is ", (3 ** 4), " and Data Type is ", type(3 ** 4))
